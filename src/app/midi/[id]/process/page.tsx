      ...
      {data.status === 'completed' && (
        <div className="w-full space-y-4">
          ...
          <div className="flex justify-center pt-2">
            <Link href="/" className="flex items-center gap-2 px-6 py-3 bg-zinc-800 dark:bg-zinc-200 text-white dark:text-black rounded-lg font-medium hover:bg-zinc-700 dark:hover:bg-zinc-300 transition-colors">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
